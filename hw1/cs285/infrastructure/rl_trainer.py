...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        """
        if itr == 0:
            # we are in the first iteration, lets load the expert data
            with open(load_initial_expertdata, "rb") as fp:
                loaded_paths = pickle.load(fp)
                return loaded_paths, 0, None

        # TODO decide whether to load training data or use the current policy to collect more data -> DONE
        ...
        # TODO collect `batch_size` samples to be used for training -> DONE
        # HINT1: use sample_trajectories from utils
        # HINT2: you want each of these collected rollouts to be of length self.params['ep_len']
        print("\nCollecting data to be used for training...")
        paths, envsteps_this_batch = sample_trajectories(env=self.env, policy=collect_policy, min_timesteps_per_batch=batch_size,
        ...
        if self.log_video:
            ...
            # TODO look in utils and implement sample_n_trajectories -> DONE
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            # TODO use the sampled data to train an agent -> DONE
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        # and replace paths[i]["action"] with these expert labels -> DONE
        for path in paths:
